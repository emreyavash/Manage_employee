...
const Pagination = ({pages,setCurrentPage,currentEmployees,totalEmployees}) => {
  const numOfPages = [];
  ...
  return (
    <div className="clearfix">
      <div className="hint-text">
        Showing <b>{currentEmployees.length}</b> out of <b>{totalEmployees.length}</b> entries
      </div>
